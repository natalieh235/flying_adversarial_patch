...
void BNReluConvolution4(
  ...
  DMA_copy_k.length_1d_copy = (uint16_t) 512;
  ...
  DMA_copy_lambda.length_1d_copy = (uint16_t) 512;
  ...
  DMA_copy_W.ext = l2_W;
  DMA_copy_W.loc = (l1_buffer + 11536) + 0;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    if(iter < (total_tiles-1) )
    {
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 11536) + db_W;
    ...
    k = (int64_t *) (l1_buffer + 29976 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 30496 + exec_db_act);
    W = (char *) (l1_buffer + 11536 + exec_db_W);
    ...
    y_tile_size_w   = (_i_w_exec+1 == 1)   ? 10 : 10;
    ...
    {                        
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 6, 10, 64, 10, 64, 0, 0, 0, 0, 0, 0, 8);
