...
void BNReluConvolution2(
  ...
  DMA_copy_k.loc = (uint32_t) l1_buffer + 30296;
  ...
  DMA_copy_lambda.loc = (uint32_t) l1_buffer + 30816;
  ...
  DMA_copy_W.ext = l2_W;
  DMA_copy_W.loc = (l1_buffer + 11856) + 0;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    if(iter < (total_tiles-1) )
    {
      ...
      x_tile_size_w   = (_i_w_load+1 == 5)   ? 9 : 9;
      ...
      DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 17, 9, 32, 40, 32,  1, 1,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 11856) + db_W;
    ...
    k = (int64_t *) (l1_buffer + 30296 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 30816 + exec_db_act);
    W = (char *) (l1_buffer + 11856 + exec_db_W);
    y = (char *) (l1_buffer + 9800 + db_y);
    ...
    x_tile_size_w_exec   = (_i_w_exec+1 == 5)   ? 9 : 9;
    ...
    {                        
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 8, 4, 32, 20, 32, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 9800) + db_y;
