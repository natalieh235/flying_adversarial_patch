...
void BNReluConvolution0(
  ...
  DMA_copy_k.loc = (uint32_t) l1_buffer + 34666;
  ...
  DMA_copy_lambda.loc = (uint32_t) l1_buffer + 35186;
  ...
  DMA_copy_x.number_of_1d_copies = 115;
  DMA_copy_x.length_1d_copy = 1;
  dory_dma_memcpy_async(DMA_copy_x);
  dory_dma_barrier(DMA_copy_x);

  DMA_copy_W.ext = l2_W;
  DMA_copy_W.loc = (l1_buffer + 33058) + 0;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    if(iter < (total_tiles-1) )
    {
      ...
      x_tile_size_w   = (_i_w_load+1 == 2)   ? 50 : 115;
      ...
      DMA_copy_x.ext = dory_get_tile_3d(l2_x, _i_h_load, _i_w_load, _i_nif_load, 19, 115, 1, 160, 1,  3, 3,0, pad_offset_h, pad_offset_w, 0, 8);
      ...
      if (_i_nif_load!=_i_nif_exec || _i_nof_load!=_i_nof_exec)
      {
        ...
        DMA_copy_W.loc = (l1_buffer + 33058) + db_W;
    ...
    k = (int64_t *) (l1_buffer + 34666 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 35186 + exec_db_act);
    W = (char *) (l1_buffer + 33058 + exec_db_W);
    y = (char *) (l1_buffer + 4378 + db_y);
    ...
    x_tile_size_w_exec   = (_i_w_exec+1 == 2)   ? 50 : 115;
    y_tile_size_nof = (_i_nof_exec+1 == 1) ? 32 : 32;
    y_tile_size_h   = (_i_h_exec+1 == 6)   ? 8 : 8;
    y_tile_size_w   = (_i_w_exec+1 == 2)   ? 24 : 56;
    ...
    {                        
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 8, 56, 32, 80, 32, 0, 0, 0, 0, 0, 0, 8);
      DMA_copy_y.loc = (l1_buffer + 4378) + db_y;
