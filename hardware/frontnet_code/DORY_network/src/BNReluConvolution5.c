...
void BNReluConvolution5(
  ...
  DMA_copy_k.loc = (uint32_t) l1_buffer + 25752;
  ...
  DMA_copy_lambda.loc = (uint32_t) l1_buffer + 26016;
...
///////// POSSIBLE BUG FIX!!!!! DB_STATE_Y NOT SWITCHED /////////////
    ...
    k = (int64_t *) (l1_buffer + 25752 + exec_db_act);
    lambda = (int64_t *) (l1_buffer + 26016 + exec_db_act);
    W = (char *) (l1_buffer + 7312 + exec_db_W);
    y = (char *) (l1_buffer + 6152 + db_y);
    ...
    {                        
      ...
      DMA_copy_y.ext = dory_get_tile_3d(l2_y, _i_h_exec, _i_w_exec, _i_nof_exec, 6, 6, 16, 10, 64, 0, 0, 0, 0, 0, 0, 8);
